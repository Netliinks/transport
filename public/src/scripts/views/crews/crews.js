...
//
import { deleteEntity, getEntityData, registerEntity, setPassword, updateEntity, getFilterEntityData, getFilterEntityCount } from "../../endpoints.js";
import { drawTagsIntoTables, inputObserver, inputSelect, CloseDialog, filterDataByHeaderType, pageNumbers, fillBtnPagination, userPermissions, currentDateTime, eventLog } from "../../tools.js";
...
export class Crews {
    ...
    test(offsetInitial) {
        const buttonKey = document.getElementById('open-vehicular');
        //let offset = 0
        buttonKey.addEventListener('click', async () => {
            modalTable(0);
        });
        async function modalTable(offset) {
