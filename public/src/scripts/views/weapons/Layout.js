...
<div class="datatable" id="datatable">
  <div class="datatable_header">
    <div class="datatable_title" id="datatable-title"><h1>Armas</h1></div>
    <div class="datatable_tools" id="datatable-tools">
      ...
      <button
        ...
        id="import-entities" style="display:${userPermissions().style};">
        Importar
      </button>
  ...
  <table class="datatable_content">
    <thead><tr>
      ...
      <th><span data-type="serie">
        Serie <i class="fa-regular fa-filter"></i>
      </span></th>
