...
import { drawTagsIntoTables, inputObserver, inputSelect, CloseDialog, filterDataByHeaderType, pageNumbers, fillBtnPagination, userPermissions, currentDateTime, eventLog, getSearch, getNothing } from "../../tools.js";
    ...
    remove() {
        ...
        remove.forEach((remove) => {
            ...
            remove.addEventListener('click', async () => {
                const data = await getEntityData('Weapon', entityId);
                this.dialogContainer.style.display = 'block';
                this.dialogContainer.innerHTML = `
                    <div class="dialog_content" id="dialog-content">
