...
import { drawTagsIntoTables, inputObserver, CloseDialog, filterDataByHeaderType, pageNumbers, fillBtnPagination, userPermissions, currentDateTime, eventLog } from "../../tools.js";
        ...
        this.export = () => {
            ...
            `;
                ...
                exportButton.addEventListener('click', async () => {
                    ...
                    const users = await getFilterEntityData("City", rawExport); //await getWeapons()
