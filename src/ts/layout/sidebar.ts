...
export class Sidebar {
  ...
  `
    ...
    public renders(): void {
        ...
        document.getElementById('render-admins')?.addEventListener('click', (): void => {
          new Admins().render(Config.offset, Config.currentPage, "")
        })

        document.getElementById('render-vehiculars')?.addEventListener('click', (): void => {
          new Vehiculars().render(Config.offset, Config.currentPage, "")
        })

        document.getElementById('render-weapons')?.addEventListener('click', (): void => {
          new Weapons().render(Config.offset, Config.currentPage, "")
        })

        document.getElementById('render-operators')?.addEventListener('click', (): void => {
