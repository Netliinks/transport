...
import { drawTagsIntoTables, inputObserver, inputSelect, CloseDialog, filterDataByHeaderType, getVerifyEmail, pageNumbers, fillBtnPagination, userPermissions, currentDateTime, eventLog, inputSelectType, getSearch, getNothing } from "../../tools.js"
...
let dataPage: any
const getVehiculars = async (): Promise<void> => {
...
export class Vehiculars {
    ...
    public async render(offset: any, actualPage: any, search: any): Promise<void> {
        ...
        let data: any = await getVehiculars()
                ...
                <div class="sidebar_section">
                    <div class="file_template">
                        ...
                        <div class="description">
                            <p class="filename">Plantilla de Vehículos</p>
                            <a
                            href="./public/src/templates/Vehicles.csv"
                            download="./public/src/templates/Vehicles.csv"
                            rel="noopener"
            ...
            async function readFile(file: any) {
                ...
                fileReader.addEventListener('load', async (e: any) => {
                    ...
                    for (let i = 1; i < resultSplit.length-1; i++) {
                        ...
                        let searchExist = await getSearch("licensePlate", userData[0]?.replace(/\n/g, '').toUpperCase(), "Vehicular")
                        rawFile = JSON.stringify({
                            "licensePlate": `${userData[0]?.replace(/\n/g, '')}`,
                            "type": `${userData[1]?.replace(/\n/g, '')}`,
                            "vehicularState": {
                                "id": `${vehicularState.id}`,
                            },
                            "business": {
                                "id": `${businessId}`
                            },
    ...
    private export = (): void => {
        const exportVehiculars: InterfaceElement = document.getElementById('export-entities');
