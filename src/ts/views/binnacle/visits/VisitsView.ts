...
export class Visits {
    ...
    private previewVisit = async (): Promise<void> => {
        ...
        const renderInterface = async (entity: string): Promise<void> => {
            ...
            const picture: InterfaceElement = document.getElementById('image1')
            const picture1: InterfaceElement = document.getElementById('camera1')
            const picture2: InterfaceElement = document.getElementById('camera2')
            const picture3: InterfaceElement = document.getElementById('camera3')
            const picture4: InterfaceElement = document.getElementById('camera4')
