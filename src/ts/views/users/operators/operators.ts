...
export class Operators {
    ...
    public searchEntity = async (tableBody: InterfaceElement/*, data: any*/) => {
        ...
        btnSearch.addEventListener('click', async () => {
            new Operators().render(Config.offset , Config.currentPage, search.value.toLowerCase().trim())
        })
    }
        ...
        const renderInterface = async (entities: string): Promise<void> => {
            ...
            this.entityDialogContainer.innerHTML = `
                ...
                <div class="entity_editor_header">
                    ...
                    <h1 class="entity_editor_title">Registrar <br><small>Operador</small></h1>
                    </div>
            ...
            registerEntity(raw, 'User')
                .then((res) => {
                    setTimeout(async () => {
                        ...
                        eventLog('INS', 'OPERADOR', `${parse.username}`, '')
                        const tableBody: InterfaceElement = document.getElementById('datatable-body')
                        const container: InterfaceElement = document.getElementById('entity-editor-container')

                        new CloseDialog().x(container)
                        new Operators().render(Config.offset, Config.currentPage, infoPage.search)
            ...
            <div class="entity_editor" id="entity-editor">
              <div class="entity_editor_header">
                <div class="user_info">
                  ...
                  <h1 class="entity_editor_title">Importar <br><small>Operadores</small></h1>
                </div>
                ...
                <div class="sidebar_section">
                    <div class="file_template">
                        ...
                        <div class="description">
                            <p class="filename">Plantilla de Operadores</p>
                            <a
                        ...
                        elem.forEach((el: any) => {
                            registerEntity(el, 'User')
                                ...
                                setTimeout(async () => {
                                    ...
                                    eventLog('INS', 'OPERADOR', `${parse.username}, importación`, '')
                ...
                updateEntity('User', entityId, raw)
                    .then((res) => {
                        setTimeout(async () => {
                            ...
                            //data = await getUsers()
                            eventLog('UPD', 'OPERADOR', `${user}`, '')
                            new CloseDialog()
                                .x(container =
                                    document.getElementById('entity-editor-container')
                                )
                            new Operators().render(infoPage.offset, infoPage.currentPage, infoPage.search)
    ...
    private changeUserPassword(): void {
        ...
        changeUserPasswordKeys.forEach((buttonKey: InterfaceElement): void => {
            buttonKey.addEventListener('click', async (): Promise<void> => {
                ...
                let userName: string = buttonKey.dataset.username
                ...
                _updatePasswordButton.addEventListener('click', () => {
                    if (_password.value === '') {
                        ...
                        setPassword(raw)
                            .then((): void => {
                                setTimeout((): void => {
                                    eventLog('UPD', 'OPERADOR', `${userName}, cambio de clave`, '')
            ...
            remove.addEventListener('click', (): void => {
                ...
                this.dialogContainer.innerHTML = `
                    <div class="dialog_content" id="dialog-content">
                        ...
                        <div class="dialog_container">
                            <div class="dialog_header">
                            <h2>¿Deseas eliminar este operador?</h2>
                            </div>
                ...
                deleteButton.onclick = () => {
                    ...
                    .then((res) => {
                        setTimeout(async () => {
                            //let data = await getUsers();
                            eventLog('DLT', 'OPERADOR', `${entityName}`, '')
                            const tableBody = document.getElementById('datatable-body');
    ...
    private pagination(items: [], limitRows: number, currentPage: number) {
        ...
        function setupButtons(page: any /*, items: any, currentPage: number, tableBody: InterfaceElement, limitRows: number*/) {
            ...
            button.addEventListener('click', (): void => {
                ...
                currentPage = page
                new Operators().render(infoPage.offset, currentPage, infoPage.search)
        ...
        function setupButtonsEvents(prevButton: InterfaceElement, nextButton: InterfaceElement) {
            ...
            nextButton.addEventListener('click', (): void => {
                ...
                new Operators().render(infoPage.offset, pageCount, infoPage.search)
            })
        }
    }
