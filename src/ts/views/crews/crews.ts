...
import { drawTagsIntoTables, inputObserver, inputSelect, CloseDialog, filterDataByHeaderType, getVerifyEmail, pageNumbers, fillBtnPagination, userPermissions, currentDateTime, eventLog, getNothing, getUpdateState } from "../../tools.js"
...
export class Crews {
    ...
    private register() {
        ...
        const reg = async (raw: any, dataArray: any) => {
                ...
                updateEntity('Crew', entityId, raw)
                    .then((res) => {
                        setTimeout(async () => {
                            ...
                            //CHANGES
                            dataChangesArray.forEach((crew: any) => {
                                getUpdateState(crew.state, crew.table, crew.id)
                                let message = ""
                                if(crew.table == "Vehicular"){
                                    message = `${crew.value} asignado a patrulla: ${parse.name}`
        ...
        remove.forEach((remove: InterfaceElement) => {
            ...
            remove.addEventListener('click', (): void => {
                ...
                deleteButton.onclick = async () => {
                    ...
                    const data: any = await getEntityData('Crew', entityId)
    ...
    private selectDelete(nothingConfig: any): void {
        ...
        deletes.segundero.addEventListener('click', async (): Promise<void> => {
